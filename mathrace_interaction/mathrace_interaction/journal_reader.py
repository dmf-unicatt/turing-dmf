...
class AbstractJournalReader(abc.ABC):
    ...
    def __init__(self, journal_stream: typing.TextIO, race_name: str, race_date: datetime.datetime) -> None:
    ...
    def read(self) -> TuringDict:
        ...
        # Set name and date
        turing_dict["nome"] = self._race_name
        turing_dict["inizio"] = self._race_date.isoformat()
...
class JournalReaderR5539(AbstractJournalReader):
    ...
    def _process_race_definition_line(self, line: str, turing_dict: TuringDict) -> None:
        ...
        # Determine the participating teams from the first part
    ...
    def _convert_timestamp_to_datetime(
        ...
        return self._race_date + datetime.timedelta(seconds=timestamp)
...
class JournalReaderR17548(JournalReaderR17505):
    ...
    def _process_race_definition_line(self, line: str, turing_dict: TuringDict) -> None:
        ...
        # Determine the participating teams from the first part. This may also include the initial score
...
def journal_reader(
    journal_stream: typing.TextIO, race_name: str, race_date: datetime.datetime
) -> AbstractJournalReader:
    """
    Read a mathrace journal.
    ...
    # The previous called has consumed the stream: reset it back to the beginning
    ...
    return journal_reader_class(journal_stream, race_name, race_date)  # type: ignore[no-any-return]
