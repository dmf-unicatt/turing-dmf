...
class AbstractJournalReader(abc.ABC):
    ...
    ----------------
    RACE_DEFINITION
        The race setup code associated to the race definition: to be initialized in child classes.
    QUESTION_DEFINITION
        The race setup code associated to the question definition: to be initialized in child classes.
    RACE_START
        The race event code associated to the start of the race: to be initialized in child classes.
    JOLLY_SELECTION
        The race event code associated to jolly selection by a team: to be initialized in child classes.
    ANSWER_SUBMISSION
        The race event code associated to answer submission by a team: to be initialized in child classes.
    JOLLY_TIMEOUT
        The race event code associated to jolly timeout: to be initialized in child classes.
    TIMER_UPDATE
        The race event code associated to a timer update: to be initialized in child classes.
    RACE_SUSPENDED
        The race event code associated to a race suspension: to be initialized in child classes.
    RACE_RESUMED
        The race event code associated to a race resumption: to be initialized in child classes.
    RACE_END
        The race event code associated to the end of the race: to be initialized in child classes.
    MANUAL_BONUS
        The race event code associated to the manual addition of a bonus: to be initialized in child classes.
    """
...
class JournalReaderR5539(AbstractJournalReader):
    ...
    ----------------
    RACE_DEFINITION
        The race setup code associated to the race definition.
    QUESTION_DEFINITION
        The race setup code associated to the question definition.
    RACE_START
        The race event code associated to the start of the race.
    JOLLY_SELECTION
        The race event code associated to jolly selection by a team.
    ANSWER_SUBMISSION
        The race event code associated to answer submission by a team.
    JOLLY_TIMEOUT
        The race event code associated to jolly timeout.
    TIMER_UPDATE
        The race event code associated to a timer update.
    RACE_SUSPENDED
        The race event code associated to a race suspension.
    RACE_RESUMED
        The race event code associated to a race resumption.
    RACE_END
        The race event code associated to the end of the race.
    MANUAL_BONUS
        The race event code associated to the manual addition of a bonus.
    """
...
class JournalReaderR11167(JournalReaderR5539):
    ...
    ----------------
    RACE_START
        The race event code associated to the start of the race (changed from r5539).
    JOLLY_SELECTION
        The race event code associated to jolly selection by a team (changed from r5539).
    ANSWER_SUBMISSION
        The race event code associated to answer submission by a team (changed from r5539).
    JOLLY_TIMEOUT
        The race event code associated to jolly timeout (changed from r5539).
    TIMER_UPDATE
        The race event code associated to a timer update (changed from r5539).
    RACE_SUSPENDED
        The race event code associated to a race suspension (changed from r5539).
    RACE_RESUMED
        The race event code associated to a race resumption (changed from r5539).
    RACE_END
        The race event code associated to the end of the race (changed from r5539).
    MANUAL_BONUS
        The race event code associated to the manual addition of a bonus (changed from r5539).
    """
...
class JournalReaderR11189(JournalReaderR11184):
    ...
    Class Attributes
    ----------------
    TIMER_UPDATE_OTHER_TIMER
        The race event code associated to a timer update of the second timer.
    """

    TIMER_UPDATE_OTHER_TIMER = "901"
...
class JournalReaderR17505(JournalReaderR17497):
    ...
    ----------------
    TEAM_DEFINITION
        The race setup code associated to the definition of a team.
    """
...
class JournalReaderR17548(JournalReaderR17505):
    ...
    Class Attributes
    ----------------
    RACE_DEFINITION_ALTERNATIVE
        The race setup code associated to the alternative race definition.
    """

    RACE_DEFINITION_ALTERNATIVE = "002"
...
class JournalReaderR20642(JournalReaderR17548):
    ...
    ----------------
    BONUS_DEFINITION
        The race setup code associated to bonus definition.
    SUPERBONUS_DEFINITION
        The race setup code associated to superbonus definition.
    """

    BONUS_DEFINITION = "011"
    SUPERBONUS_DEFINITION = "012"
