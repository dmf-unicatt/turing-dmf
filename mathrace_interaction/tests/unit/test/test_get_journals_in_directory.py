...
"""Test mathrace_interaction.test.get_journals_in_directory."""
...
def test_get_journals_in_directory_empty() -> None:
    ...
    with tempfile.TemporaryDirectory() as directory:
        assert len(mathrace_interaction.test.get_journals_in_directory(pathlib.Path(directory))) == 0
...
def test_get_journals_in_directory_only_files() -> None:
    ...
    with tempfile.TemporaryDirectory() as directory:
        ...
        assert len(mathrace_interaction.test.get_journals_in_directory(pathlib.Path(directory))) == 2
...
def test_get_journals_in_directory_symbolic_link(
