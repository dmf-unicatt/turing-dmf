...
def test_strip_comments_and_unhandled_events_from_journal(
    ...
    assert expected_stripped_journal.read() == strip_comments_and_unhandled_events_from_journal(random_journal)
...
def test_strip_comments_and_unhandled_events_from_journal_entrypoint(
    random_journal: io.StringIO, expected_stripped_journal: io.StringIO, run_entrypoint: RunEntrypointFixtureType,
